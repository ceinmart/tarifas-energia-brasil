...
Versao documentada: 0.1.0-alpha.9  
Gerado em: 2026-04-25 22:05:00 -03:00  
Criado por: Codex  
...
## Atualizacao 0.1.0-alpha.9

Esta versao ajusta o sensor `Fio B final` para representar o custo efetivo da compensacao de energia observado na fatura: TUSD de consumo final menos TUSD injetada creditada final. O calculo usa ICMS de referencia da faixa residencial cheia para a TUSD consumida e ICMS zero para a energia compensada, preservando PIS/COFINS.

O sensor tambem passa a expor atributos de auditoria, incluindo a expressao textual do calculo, Fio B com transicao, TUSD de consumo final, TUSD creditada final, ICMS de consumo, ICMS de compensacao e PIS/COFINS aplicados.
