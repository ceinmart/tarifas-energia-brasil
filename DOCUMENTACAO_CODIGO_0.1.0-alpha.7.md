...
Versao documentada: 0.1.0-alpha.7  
Gerado em: 2026-04-25 00:00:00 -03:00  
Criado por: Codex  
...
## Atualizacao 0.1.0-alpha.7

Esta versao corrige o fechamento das quebras diaria, semanal e mensal quando a leitura termina exatamente na virada do periodo. O coordinator passa a garantir que, depois de distribuir o delta no periodo encerrado, a chave corrente seja avancada e publicada zerada quando o instante atual ja pertence ao novo periodo.

O recalculo dinamico tambem passa a atualizar ICMS, tarifa convencional final, Tarifa Branca final e Fio B final usando como base o consumo mensal apurado. Com isso, valores de conta regular e conta com geracao acompanham mudancas de faixa de ICMS durante o ciclo sem depender de nova coleta externa completa.
