...
Versao documentada: 0.1.0-alpha.8  
Gerado em: 2026-04-25 20:36:47 -03:00  
Criado por: Codex  
...
## Atualizacao 0.1.0-alpha.8

Esta versao separa o valor real de consumo do valor faturavel mensal. As quebras diaria e semanal deixam de aplicar custo de disponibilidade, enquanto os sensores mensais de valor de conta passam a refletir a conta a pagar quando o minimo regulatorio for maior que o consumo calculado.

Foram adicionadas entidades mensais sem disponibilidade para consumo regular, Tarifa Branca e conta com geracao/SCEE, permitindo comparar o consumo real com o valor final de faturamento. A coleta ANEEL via CSV tambem passa a filtrar registros em streaming com timeouts maiores, reduzindo uso de memoria e falhas em recursos lentos.
